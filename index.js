const PROJECTS = [
    ...
    },
    {
        ...
        longDescription: 'BuddGet is a full-stack application to handle budgets and save some money. A regular user can create categories, add payments and see the total spending by category. BuddGet was built using Ruby on Rails for both, front and back ends, and PostgreSQL for data storage. BuddGet uses Devise for authentication and CanCanCan for authorization.',
        image: 'buddget.svg',
    ...
    },
    {
        ...
        longDescription: 'OS Conference 2025 is a static website for an umbrella conference, composed of a collection of events covering the most important technologies, topics, and issues affecting open source today and created with HTML, CSS, and JavaScript. The website is fully responsive and was created using a mobile-first approach.',
